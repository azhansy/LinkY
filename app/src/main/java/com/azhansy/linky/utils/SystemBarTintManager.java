...
public class SystemBarTintManager {
     ...
     */
    public static final int DEFAULT_TINT_COLOR = LinkApplication.getInstance().getResources().getColor(R.color.black);
    ...
    public SystemBarTintManager(Activity activity, ViewGroup decorViewGroup) {
        ...
        mDecorViewGroup = decorViewGroup;
    ...
    public void removeStatusBarView() {
        if (mStatusBarAvailable) {
            if (mDecorViewGroup != null && mStatusBarTintView != null) {
                mDecorViewGroup.removeView(mStatusBarTintView);
    ...
    public static class SystemBarConfig {
        ...
        private int getActionBarHeight(Context context) {
            ...
            result = (int) Math.ceil( 25 * metrics.density);
